                ...
                children: [
                    ...
                    },
                    {
                        ...
                        children: [
                            ...
                            {
                                path: 'gallery',
                                component: resolve => require(["./components/user/gallery/index.vue"], resolve),
                                children: [
                                    {
                                        path: '',
                                        name: 'view-user-gallery',
                                        component: resolve => require(["./components/user/gallery/gallery.vue"], resolve)
                                    },{
                                        path: 'create',
                                        name: 'create-user-gallery',
                                        component: resolve => require(["./components/user/gallery/create.vue"], resolve)
                                    },
